...
import { Collapse, FadeIn } from "../../../components";
      ...
      <div className="questions">
        ...
        <div className="questions__container container">
          ...
          <div className="questions__list">
            ...
            <FadeIn as="div" delay={600} origin={"bottom"}>
              <Collapse title={"¿Cómo se beneficia mi negocio con QRupones?"}>
                <p>
                  ...
                  negocio ayudando a comprender a tus consumidores, reduciendo
                  el costo de mercadeo, comunicaciones y desarrollando una
                  ventaja competitiva para personalizar la experiencia que
                  brindas a tus clientes.
                  <br />
                  <b>✅Creación de campañas específicas:</b> Logrando segmentar
                  tu público en función de sus intereses, historial de compras u
                  otros factores relevantes, puedes adaptar tus campañas de
                  QRupones a grupos de clientes específicos.
                  <br />
                  <b>✅Toma de decisiones:</b> Al momento de tomar desiciones,
                  los datos recoletados de Qrupones ayudan a que tu negocio este
                  informado sobre dónde asignar su presupuesto, el historial de
                  compras y qué recursos de marketing necesitan para crear
                  campañas exitosas.
                  <br />
                  <b>✅Aumentar las ventas:</b> los QRupones están diseñados
                  para impulsar las ventas creando una sensación de urgencia y
                  animando a los clientes a realizar una compra debido a que es
                  automatizado, personalizado y el envió es vía whatsapp.
                  <br />
                  <b>✅Limpiar el inventario:</b> si tienes un exceso de
                  inventario o productos que no se venden tan bien como
                  esperabas, QRupones ayuda a incentivar a los clientes a
                  comprarlos, lo que le permite liberar espacio para nuevos
                  productos y minimizar las pérdidas.
                </p>
              </Collapse>
            </FadeIn>
            ...
            <FadeIn as="div" delay={600} origin={"bottom"}>
              <Collapse
                title={"¿Como puedo supervisar mi negocio con QRupones?"}
              >
                <p>
                  Tu negocio esta bajo control con QRupones. Contamos con un
                  Dashboard en tiempo real donde logras ver tus ventas y
                  recompras con Qrupones, supervisar la eficiencia de tus
                  sucursales y conocer otros indicadores que te ayudaran a tomar
                  mejores decisiones.
                </p>
              </Collapse>
            </FadeIn>
